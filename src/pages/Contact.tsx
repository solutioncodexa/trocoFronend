                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex -space-x-2 overflow-hidden">
                      <a
                        ...
                        aria-label="Facebook"
                        className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-blue-600 ring-2 ring-white transition-colors hover:bg-blue-700 sm:h-10 sm:w-10"
                      >
                      ...
                      <a
                        ...
                        className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-purple-600 to-pink-600 ring-2 ring-white transition-colors hover:from-purple-700 hover:to-pink-700 sm:h-10 sm:w-10"
                      >
                      ...
                      <a
                        ...
                        rel="noopener noreferrer"
                        aria-label="TikTok"
                        className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-secondary-dark ring-2 ring-white transition-colors hover:bg-black sm:h-10 sm:w-10"
                      >
                      ...
                      <a
                        ...
                        rel="noopener noreferrer"
                        aria-label="WhatsApp"
                        className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-green-600 ring-2 ring-white transition-colors hover:bg-green-700 sm:h-10 sm:w-10"
                      >
                        <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
