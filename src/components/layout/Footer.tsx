...
const Footer = () => {
  return (
    <footer className="bg-royal-bordeaux text-ivory-text pt-20 pb-10 border-t-4 border-primary">
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-2 text-primary">
              ...
              <span className="text-xl font-bold font-display tracking-tight text-primary">YaraGold</span>
            </div>
            <p className="text-ivory-text/80 text-sm leading-relaxed">
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="w-10 h-10 rounded-full border border-primary/30 flex items-center justify-center text-primary hover:bg-primary hover:text-royal-bordeaux transition-all duration-300"
              >
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm text-ivory-text/90">
              ...
              <li><Link className="hover:text-primary transition-colors" to="/guide-tailles">Guide des Tailles</Link></li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm text-ivory-text/90">
              ...
              <li><Link className="hover:text-primary transition-colors" to="/livraison-retours">Livraison & Retours</Link></li>
        ...
        <div className="border-t border-primary/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-ivory-text/50">
          <p>© {new Date().getFullYear()} YaraGold. Tous droits réservés.</p>
          <div className="flex gap-6">
            <Link className="hover:text-primary transition-colors" to="#">Mentions Légales</Link>
            <Link className="hover:text-primary transition-colors" to="#">Confidentialité</Link>
            <Link className="hover:text-primary transition-colors" to="#">CGV</Link>
          </div>
        </div>
      </div>
    </footer>
