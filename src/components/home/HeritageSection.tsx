...
import { CONTACT_WHATSAPP_URL, FACEBOOK_PAGE_URL, INSTAGRAM_URL, TIKTOK_URL } from '@/config/site';
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-2 pt-1 sm:pt-0">
                <div className="flex -space-x-2 overflow-hidden shrink-0">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center h-11 w-11 sm:h-10 sm:w-10 rounded-full ring-2 ring-white bg-green-600 hover:bg-green-700 transition-colors"
                    aria-label="WhatsApp"
                  >
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
