...
const SurMesureSection = () => {
  ...
  return (
    <section className="w-full min-w-0 min-h-0 sm:min-h-[100dvh] flex flex-col justify-center max-sm:justify-start py-6 sm:py-8 md:py-10 lg:py-12 bg-background-light dark:bg-background-dark overflow-x-clip border-y border-border/60">
      ...
      <div className="w-full max-w-[1280px] mx-auto page-padding shrink-0">
        <div className="flex flex-col lg:flex-row-reverse items-center lg:items-center gap-5 sm:gap-8 lg:gap-12 min-w-0">
          ...
          <div className="w-full min-w-0 lg:w-1/2 shrink-0 flex justify-center lg:justify-end min-h-0">
            <div className="relative p-2.5 sm:p-5 lg:p-6 border border-border/60 bg-card shadow-soft rounded-3xl w-full max-w-full min-w-0 lg:max-w-none">
              <div className="relative z-10 w-full min-h-0 aspect-[3/4] max-h-[min(48vh,400px)] sm:max-h-[min(58vh,540px)] md:max-h-[min(54vh,520px)] lg:max-h-[min(50vh,500px)] xl:max-h-[min(54vh,560px)] 2xl:max-h-[min(58vh,600px)] rounded-2xl overflow-hidden shadow-2xl">
