        ...
        {visible.map((cat) => {
          ...
          return (
            <li key={cat.id} className="max-md:shrink-0 max-md:snap-start md:min-w-0">
              ...
              >
                <span className="relative block size-[4.75rem] overflow-hidden rounded-full bg-white/10 ring-1 ring-white/20 shadow-lg transition-transform duration-300 group-hover:scale-[1.03] group-active:scale-[0.98] sm:size-20 md:size-24">
                  <img
                    src={src}
                    alt=""
                ...
                <span className="max-w-[5.5rem] text-center font-display text-[11px] leading-tight text-white/95 sm:max-w-[6rem] sm:text-xs md:max-w-none md:text-sm">
                  {cat.name}
                </span>
              </Link>
            </li>
