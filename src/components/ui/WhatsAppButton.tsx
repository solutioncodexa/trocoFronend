  ...
  return (
    <a
      ...
      className={cn(
        ...
        'supports-[padding:max(0px)]:right-[max(1.5rem,env(safe-area-inset-right))]'
      )}
    >
      <span
        aria-hidden
        className={cn(
          'hidden sm:block overflow-hidden whitespace-nowrap text-sm font-semibold tracking-wide',
          'max-w-0 opacity-0 -translate-x-2',
          'transition-all duration-500 ease-out',
          'group-hover:max-w-[9.5rem] group-hover:opacity-100 group-hover:translate-x-0',
          'group-hover:animate-soft-pulse'
        )}
      >
        Besoin d'aide ?
      </span>

      <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-green-700/40 transition-transform duration-500 group-hover:rotate-6">
